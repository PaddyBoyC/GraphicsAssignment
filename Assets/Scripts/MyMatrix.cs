...
public class MyMatrix
{
    ...
    public MyMatrix Inverse()
    {
        ...
        float b10 = (a[1, 1] * a[2, 2] * a[3, 3]) + (a[1, 2] * a[2, 3] * a[3, 1]) + (a[1, 3] * a[2, 1] * a[3, 2]) - (a[1, 1] * a[2, 3] * a[3, 2]) - (a[1, 2] * a[2, 1] * a[3, 3]) - (a[1, 3] * a[2, 2] * a[3, 1]);
        ...
        float b42 = (a[0, 0] * a[1, 2] * a[3, 1]) + (a[0, 1] * a[1, 0] * a[3, 2]) + (a[0, 2] * a[1, 1] * a[3, 0]) - (a[0, 0] * a[1, 1] * a[3, 2]) - (a[0, 1] * a[1, 2] * a[3, 0]) - (a[0, 2] * a[1, 0] * a[3, 1]);
        ...
        //N.B. I really thought this would be the solution but ho-hum I guess it's not..
    }
